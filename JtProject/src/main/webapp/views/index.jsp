              ...
              <div class="container text-center">
                <div class="row">
                  <div class="col-sm-6 image">
                    <div class="item">
                      <h1>Today Deal</h1>
                      <img class="img-fluid" src="https://images.bewakoof.com/uploads/grid/app/blue-shirts-with-chino-pants-bewakoof-blog-3-1604989070.jpg" alt="">
                    </div><!--enditem-->
                  </div><!--endcol-->
                  <div class="col-sm-6">
                    ...
                    <div class="details">
                      <h2 class="cr3">Men's Causuals</h2>
                      <p class="cr4"> Smooth and Royal<br>Shirts never Fade</p>
                      <div class="rating">
          ...
          <div class="container text-center">
            <div class="row">
              <div class="col-sm-6 image">
                <div class="item">
                  <h1>Today Deal</h1>
                  <img class="img-fluid" src="https://sc04.alicdn.com/kf/H50ca155c2f654529a32fc45fd1e83bafY.jpg" alt="">
                </div><!--enditem-->
              </div><!--endcol-->
              <div class="col-sm-6">
                <div class="top d-flex justify-content-center">
                ...
                <div class="details">
                  <h2 class="cr3">Women's Ethinic Wear</h2>
                  <p class="cr4">Beauty and Attractive<br></p>
                  <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
          ...
          <div class="container text-center">
            <div class="row">
              <div class="col-sm-6 image">
                <div class="item">
                  <h1></h1>
   <img class="img-fluid" src="https://img.freepik.com/free-photo/portrait-cute-little-boy-girl-stylish-jeans-clothes-looking-camera-studio_155003-21555.jpg?w=360" alt="">
                </div><!--enditem-->
              </div><!--endcol-->
              <div class="col-sm-6">
                <div class="top d-flex justify-content-center">
                ...
                <div class="details">
                  <h2 class="cr3">Kids's Wear</h2>
                  <p class="cr4">Children's Collections</p>
                  <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
